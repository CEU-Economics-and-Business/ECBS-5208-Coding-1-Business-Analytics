...
- We are interested in $H_0: \beta = 0, \, H_A: \beta \neq 0$ or not in our model. 
  - The estimated t-statistics is `r round(reg4$statistic[2],2)`, with p-value: `r round(reg4$p.value[2],4)`. 
  - This means we reject the $H_0$, which means the life expectancy is not uncorrelated with GDP per capita. (OR you can interpret differently...)
